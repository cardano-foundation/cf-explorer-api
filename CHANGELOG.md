...
* accommodate new ledger sync constitutional committee table ([ebd2c30](https://github.com/cardano-foundation/cf-explorer-api/commit/ebd2c30b7b6c5ddb2b66dec3dfcf326e56f4bb67))
...
* add field to gov action details ([8e5ee87](https://github.com/cardano-foundation/cf-explorer-api/commit/8e5ee87e8c3d890c3d8ea0c71fc5e4059d7b34d3))
* add filter for votes ([5fb2dc2](https://github.com/cardano-foundation/cf-explorer-api/commit/5fb2dc24c41ca30ed29898f6dec81cff81bec3cf))
...
* block distribution per epoch ([fa17449](https://github.com/cardano-foundation/cf-explorer-api/commit/fa174498eecc4941c978068cb8a72db5432ed486))
* block distribution per epoch ([1991c9a](https://github.com/cardano-foundation/cf-explorer-api/commit/1991c9a1515ebde9d1a322e7b9c1ee7d74412bec))
...
* calculate carbon emissions of an address or stake address ([4f746a7](https://github.com/cardano-foundation/cf-explorer-api/commit/4f746a7b5a644b83370a7aeec2f3220f1c45c290))
* call third party api then forward response ([84fcbe0](https://github.com/cardano-foundation/cf-explorer-api/commit/84fcbe0a2cce444323f52883d54e5c3fc413690c))
* display certificate of conformity ([b601e71](https://github.com/cardano-foundation/cf-explorer-api/commit/b601e7122e58fd5606f76306b546ad9745b647aa))
* display revocation certificate ([d34c200](https://github.com/cardano-foundation/cf-explorer-api/commit/d34c200b071198a0510ae28b21fada1732a4a74c))
...
* get bolnisi numbers ([0bf24f9](https://github.com/cardano-foundation/cf-explorer-api/commit/0bf24f9a3c72107c8ee0afaecb8b02a5d8ed0358))
...
* get details and author of gov action ([f23cd4a](https://github.com/cardano-foundation/cf-explorer-api/commit/f23cd4a405b700e0636b50ba8ba2ddc49a3e91fd))
...
* get governance action name from anchor ([4c066fb](https://github.com/cardano-foundation/cf-explorer-api/commit/4c066fbd914bb621f2641a297373844b5fe27059))
...
* get vote on gov action without filter ([c884643](https://github.com/cardano-foundation/cf-explorer-api/commit/c8846434d7b6d27affd624acb78957d9d01b3381))
* getting live data from cf-product-aggregator ([9907ae1](https://github.com/cardano-foundation/cf-explorer-api/commit/9907ae155f2af3568480860bedf6059b978f5eee))
...
* integrate new token info in token listing features ([534ec53](https://github.com/cardano-foundation/cf-explorer-api/commit/534ec5347246ff67772ba2a108a9a87244a97fae))
...
* number of stake pools in the system ([eb7d10a](https://github.com/cardano-foundation/cf-explorer-api/commit/eb7d10a85a358eaa7b9e37051b4077a7e0dad97b))
* number of stake pools in the system ([c483de3](https://github.com/cardano-foundation/cf-explorer-api/commit/c483de3e0ff31d3fb911107eb51a1e08fc316b0c))
...
* return a pool list matching the query with pagination ([ee28ca3](https://github.com/cardano-foundation/cf-explorer-api/commit/ee28ca335687505005b58dc2d298c2df6d6ab8f6))
...
* searching for staking lifecycle page ([88bb2b6](https://github.com/cardano-foundation/cf-explorer-api/commit/88bb2b699828a4d95fe09ea9a5f7dd2f6617d5fc))
...
* update url for wineries public key verification ([c8f108d](https://github.com/cardano-foundation/cf-explorer-api/commit/c8f108d145bc311a17a975d72c34c2f48d6facd4))
...
* verify public key and verify signature ([68e284d](https://github.com/cardano-foundation/cf-explorer-api/commit/68e284d725ac663df38c3b14c42be02a369ecea5))
...
* add @Builder for VoteFilter class ([fe8441a](https://github.com/cardano-foundation/cf-explorer-api/commit/fe8441ad1bac9b3f9956b266beb00554540611a8))
* add a condition to the join query to filter gov actions ([0440dde](https://github.com/cardano-foundation/cf-explorer-api/commit/0440dde21e30d3aa9c801986a81b2a7b4fd2262e))
* add API_MICAR_KEY to store api key ([5fa5a61](https://github.com/cardano-foundation/cf-explorer-api/commit/5fa5a6162447bd39ded1932e17f7dd18948b84e3))
...
* add GroupBy to the query to get a list of addresses by stake address ([316d31f](https://github.com/cardano-foundation/cf-explorer-api/commit/316d31f1991da5ec9bf1994e0bf536317568ac0d))
...
* change type of Index in GovernanceActionOverViewResponse ([c1bee96](https://github.com/cardano-foundation/cf-explorer-api/commit/c1bee96b6597b2e4ddf604aa3c940a661d8b31ef))
* correct mapper names ([37b8a4e](https://github.com/cardano-foundation/cf-explorer-api/commit/37b8a4ea9ea206205200b3c2ce0aacb83cf0a6cc))
...
* fix all failing unit test ([9324b51](https://github.com/cardano-foundation/cf-explorer-api/commit/9324b514370cb4004bdc95860ff9ecde8ebae8e1))
...
* fix unit test ([92feaa1](https://github.com/cardano-foundation/cf-explorer-api/commit/92feaa1bfc3b384e46195bb4b46359d0c99cd9c8))
* fix unit test ([dd9ced5](https://github.com/cardano-foundation/cf-explorer-api/commit/dd9ced59ed7348158d68d7bc17d832e3b4f73e84))
* fix unit test ([72ba339](https://github.com/cardano-foundation/cf-explorer-api/commit/72ba3395ac85a7be0721e93f95b9dacc6b704ab4))
* format code ([cdbaced](https://github.com/cardano-foundation/cf-explorer-api/commit/cdbaced594ece043e5d65e410393c124e135e67e))
...
* get delegator of the drep with koios ([c4674de](https://github.com/cardano-foundation/cf-explorer-api/commit/c4674de4bcd6bece25ae47ea66ab3030ed2ed060))
...
* get list of member in constitutional committee ([8b149f2](https://github.com/cardano-foundation/cf-explorer-api/commit/8b149f2e83faa78f0cfce43ab56907f5a6f87df3))
* get the gov participation is wrong ([0105b93](https://github.com/cardano-foundation/cf-explorer-api/commit/0105b93d88983e25db66e6c4d9b53729b3fa8ccd))
...
* governance voting SPO chart not loading votes ([132ee85](https://github.com/cardano-foundation/cf-explorer-api/commit/132ee856d41d8cfed0408af50cc70e31cc1c8da1))
* incorrect pagination when fetching top stake address holders ([e3655b9](https://github.com/cardano-foundation/cf-explorer-api/commit/e3655b95c6d74e5ee14418aa6348c9eb9ddd4481))
...
* modifying the condition to retrieve the threshold from metadata ([057ffbe](https://github.com/cardano-foundation/cf-explorer-api/commit/057ffbe8d47d2b0b7ab049a98ee083cdb148082b))
* precheck for null or empty values when retreiving from the script map ([a7aa203](https://github.com/cardano-foundation/cf-explorer-api/commit/a7aa203a10b20fe0b982bdf73cb9a10a10a2ade6))
...
* remove columns from block table in epoch details ([bf2a2e6](https://github.com/cardano-foundation/cf-explorer-api/commit/bf2a2e6a6833c761987c7cda6a596686e1733ff5))
* remove columns from txs table in other details ([c5c8e18](https://github.com/cardano-foundation/cf-explorer-api/commit/c5c8e185a39f90a69d7f863862a52db37f5249e1))
...
* return null if the address or stake address does not exist ([4e30d01](https://github.com/cardano-foundation/cf-explorer-api/commit/4e30d0147bbd73a135802f398a1e77da32c35675))
* return null if the address or stake address does not exist ([9f6abf2](https://github.com/cardano-foundation/cf-explorer-api/commit/9f6abf2c7d618bdc100774b9e58e171be3efbedc))
...
* several fields in off-chain data might be null ([3c1c4e7](https://github.com/cardano-foundation/cf-explorer-api/commit/3c1c4e7b9ad969ef5d85422c3269abe75efaebb6))
...
* tests ([7038980](https://github.com/cardano-foundation/cf-explorer-api/commit/70389807038c15384b1aa986226df0936f565a45))
* the search feature does not support searching by name or ticker pool ([d5257a1](https://github.com/cardano-foundation/cf-explorer-api/commit/d5257a152a79adb556cf8ece3a73f99124f8a5d6))
...
* undo changes in bolnisimetadata test ([c2f890b](https://github.com/cardano-foundation/cf-explorer-api/commit/c2f890b1169da7826a6bc598d3a77e72b1dd78b6))
* unit test failed ([f685216](https://github.com/cardano-foundation/cf-explorer-api/commit/f6852169f58c7b26b3c2aaebee760d5e6a6e6b33))
...
* update logic to single fallback url ([ae336e7](https://github.com/cardano-foundation/cf-explorer-api/commit/ae336e7249e983655d8619153ebe0b3dc1e49bf1))
* update postman collection for tests to run ([1e4cbfd](https://github.com/cardano-foundation/cf-explorer-api/commit/1e4cbfde1d4f3e82fd0f0b2d330e557f133f6db6))
...
* update url name and format ([2b5a8e5](https://github.com/cardano-foundation/cf-explorer-api/commit/2b5a8e58a29ccf64d79c115be012805d6cf7df44))
* updating postman base urls ([4cd12b2](https://github.com/cardano-foundation/cf-explorer-api/commit/4cd12b28895d3332464a8f0b6b611763fe98f551))
* updating postman collection ([f341cd7](https://github.com/cardano-foundation/cf-explorer-api/commit/f341cd70aaef16eb3f1185c4847eb8f227b1eafc))
...
* imprv perf addr detail, txs query ([f2d6f2b](https://github.com/cardano-foundation/cf-explorer-api/commit/f2d6f2b836dab8ec4e5255bf61363ec948a1afb7))
* imprv perf stake_address txs query ([ceadb20](https://github.com/cardano-foundation/cf-explorer-api/commit/ceadb20750f0816a655ac20e513da91ef96b0b09))
* imprv perf token txs query ([a308f37](https://github.com/cardano-foundation/cf-explorer-api/commit/a308f37f9865d46c52899613527b0771c78b2254))
* make filter txs by address, stake_address, token work with indexes ([984037f](https://github.com/cardano-foundation/cf-explorer-api/commit/984037f2aa9f5da0390ad43a81aa5042cd26f704))
...
* release 1.7.0 ([c2f6c57](https://github.com/cardano-foundation/cf-explorer-api/commit/c2f6c57da7c4b67a62b1416350683faf2996d409))
