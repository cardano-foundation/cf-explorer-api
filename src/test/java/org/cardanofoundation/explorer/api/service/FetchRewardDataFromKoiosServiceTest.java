...
public class FetchRewardDataFromKoiosServiceTest {
  @InjectMocks private FetchRewardDataFromKoiosServiceImpl fetchRewardDataFromKoiosService;
  ...
  void setUp() {
    ReflectionTestUtils.setField(
        fetchRewardDataFromKoiosService, "apiCheckRewardUrl", "localhost:8080");
    ReflectionTestUtils.setField(
        fetchRewardDataFromKoiosService, "apiCheckPoolHistoryUrl", "localhost:8080");
    ReflectionTestUtils.setField(
        fetchRewardDataFromKoiosService, "apiCheckEpochStakeUrl", "localhost:8080");
    ReflectionTestUtils.setField(
        fetchRewardDataFromKoiosService, "apiCheckAdaPotsUrl", "localhost:8080");
    ReflectionTestUtils.setField(
        fetchRewardDataFromKoiosService, "apiCheckEpochUrl", "localhost:8080");
  }

  @Test
  void testCheckRewardAvailable_thenReturnFalse() {
    when(rewardCheckpointRepository.checkRewardByStakeAddressAndEpoch(anyString()))
        .thenReturn(false);
  ...
  void testCheckEpochStakeForPool() {
    ...
    when(epochStakeCheckpointRepository.checkEpochStakeByAccountsAndEpoch(rewardsAccount))
        .thenReturn(size);
  ...
  void testCheckRewardForPool() {
    ...
    when(rewardCheckpointRepository.checkRewardByRewardAccountsAndEpoch(rewardAccounts))
        .thenReturn(rewardAccounts.size());
