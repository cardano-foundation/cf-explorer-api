...
class PoolCertificateServiceTest {
  ...
  void getTxPoolCertificateHistory_shouldReturnTxPoolCertificateHistory() {
    ...
    var response =
        poolCertificateService.getTxPoolCertificateHistory(
            poolViewOrHash, PageRequest.of(0, 10, Sort.by("createdAt")));
  ...
  void getCurrentPoolStatus_shouldReturnPoolActive() {
    PoolCertificateProjectionImpl latestCertificateUpdate =
        PoolCertificateProjectionImpl.builder()
            .txId(4L)
            .txEpochNo(5)
            .certEpochNo(8)
    ...
    PoolCertificateProjectionImpl latestCertificateRetire =
        PoolCertificateProjectionImpl.builder()
            .txId(3L)
            .txEpochNo(7)
            .certEpochNo(9)
