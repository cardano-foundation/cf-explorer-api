...
class StakeKeyReportControllerTest {
  ...
  @MockBean private StakeKeyReportService stakeKeyReportService;

  @MockBean private ReportHistoryService reportHistoryService;
  ...
  void shouldExportStakeKeyReportByStorageKey() throws Exception {
    ...
    StakeKeyReportResponse responseExpect =
    ...
    MvcResult result =
        mockMvc
            .perform(
                get(END_POINT + "/stake-key/{reportId}/export", reportId)
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    Assertions.assertTrue(
        result
            ...
            .split("=")[1]
            .contains(responseExpect.getFileName()));
  ...
  void shouldGetStakeKeyReportDetail() throws Exception {
    ...
    mockMvc
        .perform(
            get(END_POINT + "/stake-key/{reportId}/detail", reportId)
                .contentType(MediaType.APPLICATION_JSON)
                .with(
                    request -> {
                      request.setAttribute(
  ...
  void shouldGetStakeKeyReportHistoriesByStakeKey() throws Exception {
    ...
    List<StakeKeyReportHistoryResponse> responseList =
        Collections.singletonList(stakeKeyReportHistoryResponse);

    BDDMockito.given(
            stakeKeyReportService.getStakeKeyReportHistoryByStakeKey(
                stakeKey, username, PageRequest.of(0, 1)))
        .willReturn(new BaseFilterResponse<>(responseList, 1, 1, 0));

    mockMvc
        .perform(
            get(END_POINT + "/stake-key/{stakeKey}/history", stakeKey)
                .param("page", "0")
                .param("size", "1")
                .contentType(MediaType.APPLICATION_JSON)
                .with(
  ...
  void shouldGetAllStakeKeyReportHistories() throws Exception {
    ...
    mockMvc
        .perform(
            get(END_POINT + "/stake-key/history")
                .param("page", "0")
                .param("size", "1")
  ...
  void shouldGetReportHistoryDashBoard() throws Exception {
    ...
    BDDMockito.given(
            reportHistoryService.getReportHistory(
                any(ReportHistoryFilterRequest.class), anyString(), any(Pageable.class)))
        .willReturn(new BaseFilterResponse<>(responseList, 1, 1, 0));

    mockMvc
        .perform(
            get(END_POINT + "/dashboard")
                .param("page", "0")
                .param("size", "1")
                .contentType(MediaType.APPLICATION_JSON)
                .with(
        ...
        .andExpect(status().isOk())
        .andExpect(content().string(containsString("report_name_123")))
        .andDo(print());
  }
  ...
  void shouldGetRegistrations() throws Exception {
    ...
    given(
            stakeKeyReportService.getStakeRegistrationsByReportId(
                reportId, username, PageRequest.of(0, 1, Sort.by("time").descending())))
        .willReturn(new BaseFilterResponse<>(list, 1, 1, 0));
    mockMvc
        .perform(
            get(END_POINT + "/stake-key/{reportId}/registrations", reportId)
                .param("page", "0")
                .param("size", "1")
                .contentType(MediaType.APPLICATION_JSON)
                .with(
  ...
  void shouldGetDeRegistrations() throws Exception {
    ...
    mockMvc
        .perform(
            get(END_POINT + "/stake-key/{reportId}/de-registrations", reportId)
                .param("page", "0")
                .param("size", "1")
                .contentType(MediaType.APPLICATION_JSON)
                .with(
  ...
  void shouldGetDelegations() throws Exception {
    ...
    mockMvc
        .perform(
            get(END_POINT + "/stake-key/{reportId}/delegations", reportId)
                .param("page", "0")
                .param("size", "1")
                .contentType(MediaType.APPLICATION_JSON)
                .with(
  ...
  void shouldGetRewards() throws Exception {
    ...
    mockMvc
        .perform(
            get(END_POINT + "/stake-key/{reportId}/rewards", reportId)
                .param("page", "0")
                .param("size", "1")
                .contentType(MediaType.APPLICATION_JSON)
                .with(
  ...
  void shouldGetWithdrawals() throws Exception {
    ...
    mockMvc
        .perform(
            get(END_POINT + "/stake-key/{reportId}/withdrawals", reportId)
                .param("page", "0")
                .param("size", "1")
                .contentType(MediaType.APPLICATION_JSON)
                .with(
  ...
  void testGetReportLimit() throws Exception {
    ...
    ReportLimitResponse response =
        ReportLimitResponse.builder().isLimitReached(true).limitPer24hours(1).build();

    when(reportHistoryService.getReportLimit(userPrincipal)).thenReturn(response);

    mockMvc
        .perform(
            get(END_POINT + "/report-limit")
                .with(
                    request -> {
  ...
  private StakeKeyReportHistoryResponse getStakeKeyReportHistoryResponse(
