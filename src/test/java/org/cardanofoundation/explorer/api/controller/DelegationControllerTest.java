...
public class DelegationControllerTest {
  ...
  @MockBean private DelegationService delegationService;
  ...
  public void testGetDelegations() throws Exception {
    ...
    List<DelegationResponse> mockResponse =
        Arrays.asList(new DelegationResponse(), new DelegationResponse());
    BaseFilterResponse<DelegationResponse> response =
    ...
    mockMvc
        .perform(get("/api/v1/delegations").param("page", "0").param("size", "20"))
  ...
  public void testGetDataForDelegationHeader() throws Exception {
    ...
    // Perform the GET request
    mockMvc
        .perform(get("/api/v1/delegations/header"))
        .andExpect(status().isOk())
  ...
  public void testGetDataForPoolDetail() throws Exception {
    ...
    // Perform the GET request
    mockMvc
        .perform(get("/api/v1/delegations/pool-detail-header/{poolView}", poolView))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$").exists());
  ...
  public void testGetAnalyticsForPoolDetail() throws Exception {
    ...
    // Perform the GET request
    mockMvc
        .perform(get("/api/v1/delegations/pool-detail-analytics").param("poolView", poolView))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$").exists());
  ...
  public void testGetEpochListForPoolDetail() throws Exception {
    ...
    String poolView = "pool1m06tlj2ykawzvweacgmhxj43hykczgfuynk2lqzxvshm5lq2lyq";
    Pageable pageable = PageRequest.of(0, 10);
    List<PoolDetailEpochResponse> mockResponse =
        Arrays.asList(new PoolDetailEpochResponse(), new PoolDetailEpochResponse());
    BaseFilterResponse<PoolDetailEpochResponse> response =
        new BaseFilterResponse<>(mockResponse, pageable.getPageSize());
    ...
    mockMvc
        .perform(
            get("/api/v1/delegations/pool-detail-epochs")
  ...
  public void testGetDelegatorForPoolDetail() throws Exception {
    ...
    String poolView = "pool1m06tlj2ykawzvweacgmhxj43hykczgfuynk2lqzxvshm5lq2lyq";
    Pageable pageable = PageRequest.of(0, 10);
    List<PoolDetailDelegatorResponse> mockResponse =
        Arrays.asList(new PoolDetailDelegatorResponse(), new PoolDetailDelegatorResponse());
    BaseFilterResponse<PoolDetailDelegatorResponse> response =
        new BaseFilterResponse<>(mockResponse, pageable.getPageSize());
    ...
    mockMvc
        .perform(
            get("/api/v1/delegations/pool-detail-delegators")
                .param("poolView", poolView)
                .param("page", "0")
                .param("size", "10"))
        .andExpect(status().isOk())
  ...
  public void testFindTopDelegationPool() throws Exception {
    ...
    List<PoolResponse> mockResponse =
        Arrays.asList(new PoolResponse(), new PoolResponse(), new PoolResponse());
    ...
    // Perform the GET request
    mockMvc
        .perform(get("/api/v1/delegations/top").param("page", "0").param("size", "3"))
        .andExpect(status().isOk())
