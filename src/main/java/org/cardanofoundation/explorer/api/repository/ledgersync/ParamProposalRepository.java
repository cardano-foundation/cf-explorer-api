...
public interface ParamProposalRepository extends JpaRepository<ParamProposal, Long> {
  ...
  @Query(
      "SELECT CASE WHEN pp.minFeeA IS NOT NULL THEN pp.minFeeA ELSE ep.minFeeA END  AS minFeeA, "
          ...
          + " CASE WHEN pp.drepDeposit IS NOT NULL THEN pp.drepDeposit ELSE ep.drepDeposit END  AS drepDeposit,  "
          + " CASE WHEN pp.drepActivity IS NOT NULL THEN pp.drepActivity ELSE ep.drepActivity END  AS drepActivity,  "
          + " CASE WHEN pp.committeeMinSize IS NOT NULL THEN pp.committeeMinSize ELSE ep.committeeMinSize END  AS committeeMinSize,  "
          + " CASE WHEN pp.committeeMaxTermLength IS NOT NULL THEN pp.committeeMaxTermLength ELSE ep.committeeMaxTermLength END  AS committeeMaxTermLength,  "
          + " CASE WHEN pp.govActionDeposit IS NOT NULL THEN pp.govActionDeposit ELSE ep.govActionDeposit END  AS govActionDeposit,  "
          + " CASE WHEN pp.govActionLifetime IS NOT NULL THEN pp.govActionLifetime ELSE ep.govActionLifetime END  AS govActionLifetime,  "
          ...
          + " CASE WHEN pp.drepDeposit IS NOT NULL THEN TRUE ELSE FALSE END AS drepDepositProposal, "
          + " CASE WHEN pp.drepActivity IS NOT NULL THEN TRUE ELSE FALSE END AS drepActivityProposal, "
          + " CASE WHEN pp.govActionDeposit IS NOT NULL THEN TRUE ELSE FALSE END AS govActionDepositProposal, "
          + " CASE WHEN pp.govActionLifetime IS NOT NULL THEN TRUE ELSE FALSE END AS govActionLifetimeProposal, "
          + " CASE WHEN pp.committeeMinSize IS NOT NULL THEN TRUE ELSE FALSE END AS committeeMinSizeProposal, "
          + " CASE WHEN pp.committeeMaxTermLength IS NOT NULL THEN TRUE ELSE FALSE END AS committeeMaxTermLengthProposal, "
          + " b.time  AS blockTime,  "
