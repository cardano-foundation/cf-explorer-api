...
public class PoolReportServiceImpl implements PoolReportService {
  ...
  @Override
  public Boolean create(PoolReportCreateRequest poolReportCreateRequest, UserPrincipal userPrincipal) {
  ...
  public PoolReportHistory saveToDb(PoolReportCreateRequest poolReportCreateRequest,
    ...
    ReportHistory reportHistory = initReportHistory(poolReportCreateRequest, userPrincipal.getUsername());
