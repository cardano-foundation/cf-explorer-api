...
public class TokenController {
  ...
  public ResponseEntity<TokenResponse> getTokenDetail(@PathVariable @PrefixedValid(CommonConstant.PREFIXED_TOKEN_FINGERPRINT) String tokenId) {
  ...
  public ResponseEntity<BaseFilterResponse<TokenMintTxResponse>> getTokenMintTx(
          @PathVariable @PrefixedValid(CommonConstant.PREFIXED_TOKEN_FINGERPRINT) String tokenId, @ParameterObject @SortDefault(sort = {
  ...
  public ResponseEntity<BaseFilterResponse<TokenAddressResponse>> getTopHolders(
      @PathVariable @PrefixedValid(CommonConstant.PREFIXED_TOKEN_FINGERPRINT) String tokenId, @ParameterObject Pageable pageable) {
  ...
  public ResponseEntity<List<TokenVolumeAnalyticsResponse>> getTokenVolumeAnalytics(
      @PathVariable @PrefixedValid(CommonConstant.PREFIXED_TOKEN_FINGERPRINT) String tokenId,
